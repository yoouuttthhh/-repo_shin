...
**出力の順番**
- `# リポジトリ名` ：リポジトリ名をそのまま記載
- `## 概要` ：何のためのリポジトリか・解決する問題を1〜3行で記載
- `## ファイル構成` ：WBS形式のツリーで記載（`prompt/md.md`のルール参照）
- `## 使い方・運用ルール` ：このリポジトリの使い方・更新ルールを箇条書きで記載
...
## 関連リンク
- [CLAUDE.md](./CLAUDE.md)
- [-test_sct リポジトリ](https://github.com/yoouuttthhh/-test_sct)
```